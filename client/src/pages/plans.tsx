...
export default function Plans() {
  ...
  const plans = [
    ...
    },
    {
      ...
      description: "Everything in the Done for You plan, plus bespoke converting landing pages and managed social campaigns to drive qualified leads and grow your business.",
      features: [
        "All Done for You Features: Get the full suite of automation tools",
        "Service AI: Ideal for high volume enquiries and save your admin or front desk teams with FAQs. Perfect for accommodations, restaurants and hotels",
        "Bespoke Converting Landing Pages: Custom-built landing pages designed to convert visitors into customers",
